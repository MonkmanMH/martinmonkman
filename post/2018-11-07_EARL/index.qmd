...
- using R
- rstats
image: nasa_astronaut_canadarm.jpg
---
...
_This blog post is a long-form version of the talk I gave as part of the [EARL Conference in Seattle](https://datamishapsnight.com/) on 2018-11-07. This edition of the blog post has been edited to capture the content from the original twitter links._
...
But these policies and procedures accumulate, sometimes conflicting with one another. As Esther Derby put it on twitter:


<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Ppl seem to think about adding processes, policies, procedures...but not retiring any of them. Sort of like always buying new clothes, without ever clearing out the closet of stuff that now longer works or fits.</p>&mdash; estherderby (@estherderby), May 23, 2018
</blockquote>
...
_Source: https://www.instagram.com/p/BpYiky-BISZ/_
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">The hardest part of grad school is making sure you meet all the arbitrary style guidelines set forth by all the &quot;important&quot; people in the grad school office. </p>&mdash; DOCTOR Greg (@StatsInTheWild), July 29, 2018</blockquote>
...
### What it does and how it impacts our work
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Can anybody point me to some good resources for starting a conversation with the IT department about making #rstats, #rstudio, shiny etc an accepted part of software kit? As far as I know most of our servers are windows OS %&gt;%</p>&mdash; Adam Gruer (@AdamGruer), July 1, 2018</blockquote>


As Sean Boots has noted, the hairball limits access to hardware as well as software:

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">New blog post from me! 👋 On why your department’s standard computers probably won’t cut it for modern digital work: <a href="https://digital.canada.ca/2018/06/27/tools-to-do-good-work/">"Use the tools that you need to do good work"</a> #GCdigital</p>&mdash; Sean Boots (@sboots), July 3, 2018</blockquote>
...
In January 2018, my colleagues in the State of Environment Reporting team published the package `bcmaps` to CRAN:

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">
The `bcmaps` #rstats package just updated on CRAN, a new #opendata layer, #BritishColumbia cities & other improvements.<br>
<a href="https://CRAN.R-project.org/package=bcmaps">bcmaps: Map Layers and Spatial Utilities for British Columbia</a></p>&mdash; Env Report BC (@EnvReportBC), January 19, 2018</blockquote>


and Jenny Bryan quote tweeted:

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">I still can’t get over the fact that my province publishes #rstats packages  on CRAN and has 243 @github repos. </p>&mdash; Jenny Bryan (@JennyBryan), January 19, 2018</blockquote>
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">I&#39;m looking for a data analysis .R/.Rmd on GitHub with data understandable by a lay audience, that shows analysis changes over time. Any ideas?</p>&mdash; Hadley Wickham (@hadleywickham), March 7, 2018</blockquote>

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">If you mean analysis code changes, we updated this population data analysis code shifting to tidyverse 📦 &amp; style -&gt; master vs 2018-update branches<br>
[github.com/bcgov/bc-popul...](https://github.com/bcgov/bc-population-indicator)</p>&mdash; Stephanie Hazlitt (@stephhazlitt), March 7, 2018</a></blockquote>

<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Exactly what I’m looking for - thanks!</p>&mdash; Hadley Wickham (@hadleywickham), March 7, 2018</a></blockquote>
...
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Anyone else have the problem of being an outcome productivity person in a process productivity place?<br> <a href="https://simplystatistics.org/posts/2018-04-19-process-versus-outcome/">"Process versus outcome productivity"</a></p>&mdash; Jeff Leek (@jtleek), April 19, 2018</a></blockquote>
